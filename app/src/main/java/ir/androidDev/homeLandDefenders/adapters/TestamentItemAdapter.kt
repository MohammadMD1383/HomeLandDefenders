...
import kotlinx.android.synthetic.main.recycler_item_testament_card.view.*
...
class TestamentItemAdapter(
	...
	override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
		return ViewHolder(
			LayoutInflater.from(parent.context)
				.inflate(R.layout.recycler_item_testament_card, parent, false)
		)
	}
	...
	class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
		...
		init {
			view = itemView.crd_recyclerItemTestamentCard_cardView
			photo = itemView.iv_recyclerItemTestamentCard_photo
			name = itemView.tv_recyclerItemTestamentCard_name
		}
	}
}